package ru.startandroid.p0951servicebackpendingintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickStart(View view) {
        ...
        empty_intent = new Intent();

        // Создаем PendingIntent для Task1
        pi = createPendingResult(TASK1_CODE, empty_intent, 0);
        ...
        pi = createPendingResult(TASK2_CODE, empty_intent, 0);
        intent = new Intent(this, MyService.class)
                .putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_PINTENT, pi);
        startService(intent);

        pi = createPendingResult(TASK3_CODE, empty_intent, 0);
        intent = new Intent(this, MyService.class)
